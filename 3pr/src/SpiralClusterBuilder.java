...
public class SpiralClusterBuilder {
    ...
    static int NUM_OF_CLUSTER_CREATED = 0;
    ...
    public static class SpiralClusterReduce extends Reducer<Text, Text, Text, Text> {
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
            NUM_OF_CLUSTER_CREATED += context.getCounter(SpiralClusterReduce.CountersEnum.class.getName(), SpiralClusterReduce.CountersEnum.NUM_OF_CLUSTER_CREATED.toString()).getValue();

            String data = "NUM_OF_CLUSTER_READ = " + NUM_OF_CLUSTER_CREATED;
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("RUN TIME = " + (System.currentTimeMillis() - startTime) + "NUM_OF_CLUSTER_CREATED" + SpiralClusterReduce.CountersEnum.NUM_OF_CLUSTER_CREATED);
    }
}
