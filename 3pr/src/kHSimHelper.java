...
public class kHSimHelper {
    ...
    public static String PATH = "/home/tri/kHSim_demo1-master/";
	...
	System.out.println("diff= "+ diff + "intLower=" + intLower + "intUpper=" +intUpper);	
        switch (diff) {
            case 0: {
                int[] res = {intUpper};
                return res;
    ...
    public static void writeToFile(String folder, String query, double epsilon1, String listOfCluster1, double epsilon2, String listOfCluster2) {        
